...
public class DrawerQuintEaseAnimator: DrawerTickAnimator {
    ...
    public enum EaseType {
        ...
        internal func algorithm(value: Double) -> Double {
            ...
            case .easeIn:
                return pow(value, 5)
            case .easeOut:
                return pow(value - 1, 5) + 1
            case .easeInOut:
                if value < 0.5 {
                    return 16 * pow(value, 5)
                } else {
                    return  0.5 * pow((2 * value) - 2, 5) + 1
                }
            }
        }
    }
